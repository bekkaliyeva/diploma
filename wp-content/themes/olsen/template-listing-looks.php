	...
	<?php while ( have_posts() ) : the_post(); ?>
		...
		<?php
			...
			if( $layout == '3cols_full' ) {
				$row_column_classes  = 'col-12';
				$item_column_classes = 'col-lg-4 col-md-6 col-12';
			} else {
				$row_column_classes  = 'col-lg-8 col-12';
				$item_column_classes = 'col-md-6 col-12';
			}

			$args = array(
				'post_type' => 'post',
				'paged'     => olsen_get_page_var()
			);
								...
								<a href="<?php the_permalink(); ?>">
									...
									<?php if ( $secondary_image_id ): ?>
										<div class="entry-featured">
											<a href="<?php the_permalink(); ?>">
												<img src="<?php echo esc_url( olsen_get_image_src( $secondary_image_id, 'ci_tall' ) ); ?>" alt="<?php the_title_attribute(); ?>"/>
											</a>
										</div>
