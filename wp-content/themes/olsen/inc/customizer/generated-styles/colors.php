<?php
add_action( 'wp_head', 'olsen_customizer_css' );
if( ! function_exists( 'olsen_customizer_css' ) ):
function olsen_customizer_css() {
    ?><style type="text/css"><?php
		...
		if ( get_theme_mod( 'button_text' ) ) {
			...
			input[type="reset"],
			button.button {
				color: <?php echo get_theme_mod( 'button_text' ); ?>;
			}

			.zoom-instagram-widget .zoom-instagram-widget__follow-me a {
				color: <?php echo get_theme_mod( 'button_text' ); ?> !important;
			}
		<?php
		}

		if ( get_theme_mod( 'button_bg' ) ) {
			?>
			...
			button.button,
			.zoom-instagram-widget .zoom-instagram-widget__follow-me a {
				background-color: <?php echo get_theme_mod( 'button_bg' ); ?>;
			}
		<?php
		}

		if ( get_theme_mod( 'button_text_hover' ) ) {
			?>
			...
			button.button:hover {
				color: <?php echo get_theme_mod( 'button_text_hover' ); ?>;
			}

			.zoom-instagram-widget .zoom-instagram-widget__follow-me a:hover {
				color: <?php echo get_theme_mod( 'button_text_hover' ); ?> !important;
			}
		<?php
		}

		if ( get_theme_mod( 'button_bg_hover' ) ) {
			?>
		...
		if ( $header_bg_image ) {
			?>
			#masthead .site-logo {
				background-image: url('<?php echo esc_url_raw( $header_bg_image ); ?>');
				background-repeat: <?php echo olsen_sanitize_image_repeat( get_theme_mod( 'header_bg_image_repeat', 'no-repeat' ) ); ?>;
				background-position: <?php echo olsen_sanitize_image_position_x( get_theme_mod( 'header_bg_image_position_x', 'center' ) ) . ' ' . olsen_sanitize_image_position_y( get_theme_mod( 'header_bg_image_position_y', 'center' ) ); ?>;
				background-attachment: <?php echo olsen_sanitize_image_attachment( get_theme_mod( 'header_bg_image_attachment', 'scroll' ) ); ?>;
				<?php if ( 1 === get_theme_mod( 'header_bg_image_cover', 1 ) ) { ?>
		...
		if ( get_theme_mod( 'header_padding' ) ) {
			?>
			#masthead .site-logo {
				padding-top: <?php echo get_theme_mod( 'header_padding' ); ?>px;
				padding-bottom: <?php echo get_theme_mod( 'header_padding' ); ?>px;
			}
			<?php
		}

		// TODO: Remove this when theme reaches v2.9
...
if( ! function_exists( 'olsen_custom_background_cb' ) ):
function olsen_custom_background_cb() {
