				...
				<div class="col-12">
					...
					<?php if ( is_search() ) : ?>
						<?php
							...
							$none  = __( 'No results found. Please broaden your terms and search again.', 'olsen' );
							$one   = __( 'Just one result found. We either nailed it, or you might want to broaden your terms and search again.', 'olsen' );
							$many  = sprintf( _n( '%d result found.', '%d results found.', $found, 'olsen' ), $found );
						?>
						<article class="entry">
							<h1 class="entry-title">
								<?php _e( 'Search results' , 'olsen' ); ?>
							</h1>

							<div class="entry-content">
								<p><?php olsen_e_inflect( $found, $none, $one, $many ); ?></p>
								<?php if ( $found < 2 ) {
									get_search_form();
								} ?>
							</div>
